...
By [Vincentius Timothy](https://registry.jsonresume.org/vincentimo). Originally published on [Medium](https://medium.com/@vincentimo/preventing-integration-problems-with-continuous-integration-ci-1c2094087eba).
